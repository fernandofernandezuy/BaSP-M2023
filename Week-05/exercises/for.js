...
var musicalInstruments = ["drums", "piano", "flute", "guitar", "cello"];
for (var i = 0; i < musicalInstruments.length; i++) {
...
/* c. Crear un array vacío y con un bucle for de 10 repeticiones. Llenar el array con el número de la repetición, es decir que al final de la ejecución 
del bucle for debería haber 10 elementos dentro del array, desde el número 0 hasta al número 9. Mostrar por la consola del navegador el array final (utilizar console.log) */

...
let shortFriendship = friendship.substring(0, 5);
...
let shortFabricated = fabricated.substring(7, 10);
console.log(shortFabricated);

// d. Crear una variable de tipo string con al menos 10 caracteres y generar un nuevo string con la primera letra en mayúscula y las demás en minúscula. Guardar el resultado en una nueva variable (utilizar substring, toUpperCase, toLowerCase y el operador +).
console.log('-Exercise 2.d:');
let obligation = 'obligAtion';
let camelObligation = obligation.substring(0, 1).toUpperCase() + obligation.substring(1, 10).toLowerCase();
...
let whiteSpace = greeting.indexOf(' ');
...
let firstMonths = 'january february';
let space = firstMonths.indexOf(' ');
let camelMonth1 = firstMonths.substring(0, 1).toUpperCase() + firstMonths.substring(1, space).toLowerCase();
let camelMonth2 = firstMonths.substring(space + 1, space + 2).toUpperCase() + firstMonths.substring(space + 2, space + 10).toLowerCase();

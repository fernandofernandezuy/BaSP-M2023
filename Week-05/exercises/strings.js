...
var camelObligation = obligation.substring(0, 1).toUpperCase() + obligation.substring(1, 10).toLowerCase();
...
var camelMonth1 = firstMonths.substring(0, 1).toUpperCase() + firstMonths.substring(1, space).toLowerCase();
var camelMonth2 = firstMonths.substring(space + 1, space + 2).toUpperCase() + firstMonths.substring(space + 2, firstMonths.length).toLowerCase();
